...
public class MoteurImpl implements Moteur {
	...
	@Override
	public boolean isValidSelection(Selection s) {
		return s.getLength() <= this.content.length() && s.getStartIndex() <= this.content.length() && s.getEndIndex() <= this.content.length();
	}
